...
public class StoneBreakReplayTest {
    ...
    private Thread replayThread = new Thread() {
        ...
        public void run() {
            try {
                String replayTitle = "BreakStones";
    ...
    public void testBreakDirt(){
        ...
        Vector3i dirtLocation1 = new Vector3i(2, 1, 2);
        Vector3i dirtLocation2 = new Vector3i(2, 0, 2);
        ...
        assertEquals(worldProvider.getBlock(dirtLocation1).getDisplayName(), "Stone");
        assertEquals(worldProvider.getBlock(dirtLocation2).getDisplayName(), "Stone");
