...
public class RailGunReplayTest {
    ...
    private Thread replayThread = new Thread() {
        ...
        public void run() {
            try {
                String replayTitle = "RailGunTool";
    ...
    public void testBlocksDestroyed(){
        ...
        Vector3i testBlock1 = new Vector3i( -4, 1, 13);
        Vector3i testBlock2 = new Vector3i(-5, 1, 12);
        Vector3i testBlock3 = new Vector3i(-4, 2, 13);
        Vector3i testBlock4 = new Vector3i(-4, 2, 12);
        Vector3i testBlock5 = new Vector3i(-5, 0, 12);
        ...
        assertEquals(worldProvider.getBlock(testBlock1).getDisplayName(), "Dirt");
        ...
        assertEquals(worldProvider.getBlock(testBlock4).getDisplayName(), "Dirt");
